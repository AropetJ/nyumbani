    ...
    <header className="header">
        <div className="menu__wrapper">
          ...
          <div className="action-buttons hide">
            <a href="#log-in" title="Log in" className="secondary" onClick={handleButtonClick}>
